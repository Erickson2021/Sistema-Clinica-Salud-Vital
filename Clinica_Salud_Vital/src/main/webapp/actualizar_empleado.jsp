...
<title>CLINICA SALUD - Actualización</title>
...
<body>
 ...
 <div id="sidmenu" class="menu-collapsed">
	...
	<% EmpleadoDTO e = (EmpleadoDTO) request.getAttribute("empleado"); %>
	<div class="container">
		<h2 class="text-center">ACTUALIZACIÓN DE DOCTOR</h2>
		<hr>
		<div class="row justify-content-center">
			<form action="ServletEmpleado" method="post" class="col-10 col-sm-8 col-md-6 col-xl-4">
			<input type="hidden" name="txt_cod" value="<%= e.getCodigo() %>">
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      ...
			      class="form-control" id="txt_nom" name="txt_nom" required value="<%= e.getNombre() %>">
			    </div>
			</div>
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      ...
			      class="form-control" id="txt_pat" name="txt_pat" required value="<%= e.getApPaterno() %>">
			    </div>
			</div>
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      ...
			      class="form-control" id="txt_mat" name="txt_mat" required value="<%= e.getApMaterno() %>">
			    </div>
			</div>
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      ...
			      class="form-control" id="txt_cargo" name="txt_cargo" required value="<%= e.getCargo() %>">
			    </div>
			</div>
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      ...
			      class="form-control" id="txt_cel" name="txt_cel" required value="<%= e.getCelular() %>">
			    </div>
			</div>
			<div class="mb-3 row">
			...
			<div class="d-flex justify-content-end">
				<button class="btn btn-success me-2" name="tipo" value="actualizar"><i class="bi bi-pencil-square"></i> Actualizar</button>
				<a class="btn btn-warning" href="ServletEmpleado?tipo=listar"><i class="bi bi-arrow-90deg-left"></i> Regresar</a>
			</div>
			</form>
		</div>
	</div>
	...
	<script type="text/javascript">
		async function getDepartamentos(){
			...
			data.forEach(obj => {
				if (obj.codigo == <%= e.getDepartamento().getCodigo() %>)
					document.getElementById("cbo_depa").insertAdjacentHTML("beforeend","<option value='"+obj.codigo+"' selected>"+obj.nombre+"</option>");
				else
		...
		async function getSedes(){
			...
			const data = await res.json();
			data.forEach(obj => {
				if (obj.codigo == <%= e.getSede().getCodigo() %>)
					document.getElementById("cbo_sede").insertAdjacentHTML("beforeend","<option value='"+obj.codigo+"' selected>"+obj.nombre+"</option>");
				else
