...
<body>
 <div id="sidmenu" class="menu-collapsed">
	...
	<%
		List<EmpleadoDTO> data = (List<EmpleadoDTO>) request.getAttribute("data");
		String tipo_men = (String) request.getAttribute("tipo_men");
		String mensaje = (String) request.getAttribute("mensaje");
	%>
	<div class="container">
		<h2 class="text-center">LISTADO DE DOCTORES</h2>
		<hr>
		<% 
			if(tipo_men != null){
		%>
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><%= obj.getDepartamento().getNombre() %></td>
					<td><%= obj.getSede().getNombre() %></td>
					<td class="text-end">
