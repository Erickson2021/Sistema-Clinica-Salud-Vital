  ...
  <div id="sidmenu" class="menu-collapsed">
    ...
    <div id="form">
		...
		<div class="row justify-content-center">
			<form action="ServeletPacientes?tipo=regis" method="post" class="col-10 col-sm-8 col-md-6 col-xl-4" >
			<div class="mb-3 row">
			     <label  for="txt_dni" class="col-sm-4 col-form-label">DNI</label>
			    <div class="col-sm-8">
			      <input  type="text"  title="El dni debe ser de 8 dígitos"
			      class="form-control" id="txt_dni" name="txt_dni" required>
			    </div>
			</div>
			<div class="mb-3 row">
			...
			<div class="mb-3 row">
			    <label  for="cbo_sexo" class="col-sm-4 col-form-label">GENERO</label>
			    <div class="col-sm-8">
			...
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="txt_edad" name="txt_edad" required>
			    </div>
			</div>
			<div class="mb-3 row">
			    <label  for="txt_tele" class="col-sm-4 col-form-label">TELÉFONO</label>
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="txt_tele" name="txt_tele" required>
			    </div>
			</div>
			...
			<div class="mb-3 row">
			    ...
			    <div class="col-sm-8">
			      <input type="text" class="form-control" id="txt_dire" name="txt_dire" required>
			    </div>
			</div>
			...
			<div class="d-flex justify-content-end">
				...
				<a class="btn btn-warning" href="ServeletPacientes?tipo=listar"><i class="bi bi-arrow-90deg-left"></i> Listar Pacientes</a>
			</div>
			</form>
		</div>
	</div>
